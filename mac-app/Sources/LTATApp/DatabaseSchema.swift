...
struct DatabaseSchema {
    static func initialMigrationSQL(bundle: Bundle = .module) -> String {
        if let url = bundle.url(forResource: "001_init", withExtension: "sql", subdirectory: "Migrations"),
    ...
    /// Used if the resource cannot be loaded.
    private static let fallbackSQL = """
